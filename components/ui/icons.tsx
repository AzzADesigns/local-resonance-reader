export const IconDropbox = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2L6 6.5l6 4.5-6 4.5L0 11l6-4.5L12 2zm0 9l6-4.5L12 2l6 4.5L12 11zm6 4.5L12 11l-6 4.5 6 4.5 6-4.5zM0 11l6 4.5 6-4.5-6-4.5L0 11z" />
  </svg>
);
...
export const IconScroll = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M9 6l3-3m0 0l3 3m-3-3v18m0 0l-3-3m3 3l3-3" />
  </svg>
);
...
export const IconCrosshair = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <circle cx="12" cy="12" r="10" />
...
export const IconSpinner = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M12 2v4m0 12v4M4.93 4.93l2.83 2.83m8.48 8.48l2.83 2.83M2 12h4m12 0h4M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41">
